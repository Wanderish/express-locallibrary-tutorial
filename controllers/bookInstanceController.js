...
//require the express-validator module for body and validationResult
...
exports.bookinstance_delete_get = function(req, res) {
    ...
    .exec(function (err, bookinstance) {
      ...
      // Successful, so render.
      res.render('bookinstance_delete', { title: 'Delete instance of '+bookinstance.book.title, bookinstance: bookinstance});
    })
};
...
exports.bookinstance_delete_post = function(req, res, next) {
    ...
    BookInstance.findByIdAndDelete(req.body.bookinstanceid, function deleteInstance(err){
        if(err) { return next(err); }
